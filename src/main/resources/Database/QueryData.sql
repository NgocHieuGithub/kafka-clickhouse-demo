...
FROM tbl_report_by_productClass
...
select *
from tbl_vgp42x6v1_productClass_alarm
final ;
...
SELECT * FROM system.kafka_consumers WHERE table = 'tbl_history_alarm_kafka';